...
export default function BikesPage() {
  ...
  const [powerType, setPowerType] = useState<"leg" | "pedal_assist" | "throttle">("leg");
  ...
  return (
    <div className="max-w-lg mx-auto px-4 pt-20 pb-12">
      ...
      {/* Add bike form */}
      {showForm && (
        <form onSubmit={handleSubmit} className="bg-surface border border-border rounded p-4 mb-6 space-y-4">
          <div>
            ...
            <div key={bike.id} className="bg-surface border border-border rounded p-4">
              <div className="flex items-start justify-between mb-2">
                ...
                <button
                  ...
                  className="text-muted hover:text-severity-severe text-xs tracking-widest uppercase transition-colors flex-shrink-0 ml-2"
                  title="Delete bike"
                >
                  &times;
                </button>
